return {
  ...
  opts = {
    current_line_blame = true, -- Toggle current line blame visibility with `:Gitsigns toggle_current_line_blame`
    ...
    on_attach = function(bufnr)
      ...
      end, { desc = "Blame Line" }) -- Show blame information for the current line
      ...
      map("n", "<leader>hD", function()
        gitsigns.diffthis("~")
      end, { desc = "Diff This (Index)" }) -- Show a diff against the index
